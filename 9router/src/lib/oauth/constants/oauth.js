...
export const GEMINI_CONFIG = {
  clientId: process.env.GOOGLE_OAUTH_GEMINI_CLIENT_ID ?? "",
  clientSecret: process.env.GOOGLE_OAUTH_GEMINI_CLIENT_SECRET ?? "",
...
export const ANTIGRAVITY_CONFIG = {
  clientId: process.env.GOOGLE_OAUTH_ANTIGRAVITY_CLIENT_ID ?? "",
  clientSecret: process.env.GOOGLE_OAUTH_ANTIGRAVITY_CLIENT_SECRET ?? "",
  authorizeUrl: "https://accounts.google.com/o/oauth2/v2/auth",
  tokenUrl: "https://oauth2.googleapis.com/token",
  userInfoUrl: "https://www.googleapis.com/oauth2/v1/userinfo",
  scopes: [

...
// Google OAuth — not committed (GitHub push protection); set in .env
const GOOGLE_GEMINI_CLIENT_ID = process.env.GOOGLE_OAUTH_GEMINI_CLIENT_ID ?? "";
const GOOGLE_GEMINI_CLIENT_SECRET = process.env.GOOGLE_OAUTH_GEMINI_CLIENT_SECRET ?? "";
const GOOGLE_ANTIGRAVITY_CLIENT_ID = process.env.GOOGLE_OAUTH_ANTIGRAVITY_CLIENT_ID ?? "";
const GOOGLE_ANTIGRAVITY_CLIENT_SECRET = process.env.GOOGLE_OAUTH_ANTIGRAVITY_CLIENT_SECRET ?? "";
